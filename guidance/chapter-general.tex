...
This has been updated for the DUNE TDR. Earlier versions of this guidance document were updated for other important documents, e.g., the CDR and the ProtoDUNE-SP TDR.  These releases can be found on GitHub at \url{https://github.com/DUNE/document-guidance/releases/}.
