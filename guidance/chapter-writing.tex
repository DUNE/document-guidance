...
\begin{enumerate}
\item Download both files from DocDB 11074.
\item Read through the top-level requirements and determine which apply to your subsystem.
\item Follow the guidelines given in the template to enter any additional requirements or specifications for your subsystem.  In the validation field, be sure to include ProtoDUNE impacts and simulation studies, as appropriate. You may include additional validation information, as well.
\item Create a new DocDB entry and upload your completed spreadsheet to it.
\item Send an email to aheavey@fnal.gov with (1) your file's DocDB number and (2) the list of ``top-level'' requirements that apply to your subsystem.
\item Whenever you update your spreadsheet, remember to upload it to DocDB into a new version, and notify aheavey@fnal.gov.
\end{enumerate}

The TDR team will turn your Excel file into LaTeX and insert them into your chapter files.
