...
%In DUNE \citedocdb{11074}{1} you will find a template Excel file in which to enter your requirements or specifications.  The top-level detector specifications are also in this DocDB.  The top five (colored green) apply to all subsystems. Of the others, some will apply to your subsystem and others will not.  Note that the top-level requirements do not follow the same format as the template. (The TDR team will update them to the required format - still to do!)
In DUNE \citedocdb{11074}{2} you will find a template Excel file in which to enter your requirements or specifications.  The top-level detector specifications are included within the first 30 rows.  The top five (colored green) apply to all subsystems. Of the others (orange and blue), some will apply to your subsystem and others will not.  You will check those that apply to you.
Here are the steps to follow:

\begin{enumerate}
\item Download the file from \citedocdb{11074}{2}.
\item Read through the top-level requirements (through row 30). Click the box in the first column of those that apply to your subsystem. 
\item Follow the guidelines given in rows 1 and 2 of the template to enter any additional requirements or specifications for your subsystem, starting at row 31.  In the validation field, be sure to include ProtoDUNE impacts and simulation studies, as appropriate. You may include additional validation information, as well.
\item Upload your completed spreadsheet to your existing requirements DocDB entry, if you have one.
