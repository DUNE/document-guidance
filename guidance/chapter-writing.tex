...
\chapter{\LaTeX{} writing standards for LBNF/DUNE documents}
\label{ch:latex-stds}
...
which document it goes with. For the TDR, it is called \texttt{common/tdr-citedb.bib}. Please read the guidelines at the
