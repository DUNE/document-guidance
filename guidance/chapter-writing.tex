...
In DUNE \citedocdb{11074}{3} you will find a template Excel file in which to enter your requirements or specifications.  The file has several sheets (tabs). The TDR team has an automated way of turning the data in this file into LaTeX, hence the detailed instructions that follow:

\begin{enumerate}
\item Download the file from \citedocdb{11074}{3}.
