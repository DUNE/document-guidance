...
% 6 APA gaps
\def\apagap{\SI{20}{\milli\m}\xspace}
...
\def\spsignalsat{\num{530000} electrons\xspace}
% 15 LAr N contamination
\def\nitrogencontam{\SI{25}{ppm}\xspace}
% 16 detector live time
\def\livetime{\SI{90}{\%}\xspace}
% Engineering
% 17 Cathode resistivity
\def\cathodemegohm{\SI{1}{\mega\Omega/sq}\xspace}
% 
%\def\{\xspace}
...
\def\elecnoisenonfe{$\ll$ \SI{500}{enc}\xspace}
...
% For interface tables in TDR:
\newcommand{\citedocdb}[2]{
\href{http://docs.dunescience.org/cgi-bin/ShowDocument?docid=#1\&version=#2}{DocDB {#1}} \cite{bib:docdb#1}
\xspace}  % example of use: \citedocdb{6745}{1}
