...
This *repository* holds the source for a document that provides guidance on writing and editing  [[https://github.com/DUNE/DUNE-TDR][The DUNE TDR]] in LaTeX according to the standards that we've set up for DUNE and LBNF. Previous versions of the guidance document have been used for:
...
See [[https://wiki.dunescience.org/wiki/Physics_TDR_Volume_Development][Physics TDR Volume Development]] for information on coordination and management. 
...
** Quick start
See more detailed information in the "Getting Started" section below.

-  [[https://help.github.com/articles/signing-up-for-a-new-github-account/ Get a github account]] and send your username to Brett
...
- Do a test edit and test build (yes, twice)
#+BEGIN_EXAMPLE
